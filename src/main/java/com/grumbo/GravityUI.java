...
public class GravityUI {
    ...
    public GravityUI(GravitySimulator simulator) {
        ...
        keyEvents.add(new KeyEvent(GLFW.GLFW_KEY_W, () -> Settings.getInstance().moveCamera(new double[] {0, ZSTEP * Settings.getInstance().getZoom()})));
        keyEvents.add(new KeyEvent(GLFW.GLFW_KEY_A, () -> Settings.getInstance().moveCamera(new double[] {ZSTEP * Settings.getInstance().getZoom(), 0})));
        keyEvents.add(new KeyEvent(GLFW.GLFW_KEY_S, () -> Settings.getInstance().moveCamera(new double[] {0, -ZSTEP * Settings.getInstance().getZoom()})));
        keyEvents.add(new KeyEvent(GLFW.GLFW_KEY_D, () -> Settings.getInstance().moveCamera(new double[] {-ZSTEP * Settings.getInstance().getZoom(), 0})));
